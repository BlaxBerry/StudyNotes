...
因此**服务器与客户端之间网页内容的传输协议**又称为 超文本传输协议

（**H**yper**T**ext **T**ransfer **P**rotocol）简称**HTTP协议**



例如：

- 客户端要以HTTP协议要求的格式将数据提交到服务器
- 服务器要以HTTP协议要求的格式将数据响应给客户端
...
**服务器响应会客户端的消息内容**，也叫响应报文

---

### 组成

可通过Network的Headers中查看
